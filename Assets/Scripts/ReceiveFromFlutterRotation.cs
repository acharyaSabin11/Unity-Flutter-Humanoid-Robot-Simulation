...
public class ReceiveFromFlutterRotation : MonoBehaviour
{
    ...
    public void SetRotationAngle(string data)
    {
        ...
        try
        {
            ...
            //RightHipRoll.localRotation = Quaternion.Euler(new Vector3(0, -64, angleData.RightHipPitch));
            //RightHipPitch.localRotation = Quaternion.Euler(new Vector3(0, angleData.RightHipRoll, 0));
